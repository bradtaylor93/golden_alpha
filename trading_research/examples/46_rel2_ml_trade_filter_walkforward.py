...
EXPERIMENTS: tuple[ExperimentSpec, ...] = (
    ...
    ExperimentSpec(
        name="smart_breadth_quality_2x_ml_champion",
        use_reentry_cooldown=False,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        use_dynamic_cluster_caps=True,
    ...
    # Post-timing-fix recovery pack (compact retune around current 2x setup).
    ExperimentSpec(
        name="smart_breadth_quality_2x_recovery_core_q55_bf70",
        use_reentry_cooldown=False,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        use_dynamic_cluster_caps=True,
    ...
    ExperimentSpec(
        name="smart_breadth_quality_2x_recovery_core_q60_bf82",
        use_reentry_cooldown=False,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        use_dynamic_cluster_caps=True,
    ...
    ExperimentSpec(
        name="smart_breadth_quality_2x_recovery_bear_light",
        use_reentry_cooldown=False,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        use_dynamic_cluster_caps=True,
        ...
        use_bear_short_sleeve=True,
        sleeve_bear_short_spy_dd_threshold_override=-0.08,
        sleeve_bear_short_vol_mult_override=1.10,
        sleeve_bear_short_rel_quantile_override=0.18,
        sleeve_bear_short_max_names_override=14,
        sleeve_bear_short_gross_override=0.45,
    ),
    ExperimentSpec(
        name="smart_breadth_quality_2x_recovery_bear_medium",
        use_reentry_cooldown=False,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        use_dynamic_cluster_caps=True,
        ...
        use_bear_short_sleeve=True,
        sleeve_bear_short_spy_dd_threshold_override=-0.08,
        sleeve_bear_short_vol_mult_override=1.05,
        sleeve_bear_short_rel_quantile_override=0.22,
        sleeve_bear_short_max_names_override=18,
        sleeve_bear_short_gross_override=0.55,
    ),
    ExperimentSpec(
        name="smart_breadth_quality_2x_recovery_bear_medium_stop_tight",
        use_reentry_cooldown=False,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        use_dynamic_cluster_caps=True,
        ...
        cashflow_soft_min_scale_override=0.70,
        use_market_stop_state_machine=True,
        market_stop_stage1_drawdown_override=0.08,
        market_stop_stage2_drawdown_override=0.12,
    ...
    ExperimentSpec(
        name="smart_breadth_quality_2x_recovery_bear_light_stop_tight",
        use_reentry_cooldown=False,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        use_dynamic_cluster_caps=True,
    ...
    ExperimentSpec(
        name="smart_breadth_quality_2x_recovery_soft_prob_sizing",
        use_reentry_cooldown=False,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        use_dynamic_cluster_caps=True,
    ...
    ExperimentSpec(
        name="smart_breadth_quality_2x_exp2_regime_specialists_q56_bf78",
        use_reentry_cooldown=False,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        use_dynamic_cluster_caps=True,
    ...
    ExperimentSpec(
        name="smart_breadth_quality_2x_exp2_regime_specialists_q56_bf82",
        use_reentry_cooldown=False,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        use_dynamic_cluster_caps=True,
    ...
    ExperimentSpec(
        name="smart_breadth_quality_2x_exp2_regime_specialists_q58_bf78",
        use_reentry_cooldown=False,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        use_dynamic_cluster_caps=True,
    ...
    ExperimentSpec(
        name="smart_breadth_quality_2x_exp2_regime-specialists_q58_bf82",
        use_reentry_cooldown=False,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        use_dynamic_cluster_caps=True,
    ...
    ExperimentSpec(
        name="smart_breadth_quality_3x_ml_champion_sm_sweep_early_derisk",
        use_reentry_cooldown=False,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        use_dynamic_cluster_caps=True,
    ...
    ExperimentSpec(
        name="smart_breadth_quality_3x_ml_champion_sm_sweep_late_stage2",
        use_reentry_cooldown=False,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        use_dynamic_cluster_caps=True,
        ...
        use_market_stop_state_machine=True,
        market_stop_stage1_drawdown_override=0.10,
        market_stop_stage2_drawdown_override=0.15,
        market_stop_stage1_scale_override=0.50,
        market_stop_stage2_scale_override=0.20,
        market_stop_state_recovery_override=0.04,
        use_soft_cashflow_weighting=True,
    ...
    ExperimentSpec(
        name="smart_breadth_quality_3x_ml_champion_sm_sweep_lighter_scales",
        use_reentry_cooldown=False,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        use_dynamic_cluster_caps=True,
        ...
        use_market_stop_state_machine=True,
        market_stop_stage1_drawdown_override=0.10,
        market_stop_stage2_drawdown_override=0.14,
        market_stop_stage1_scale_override=0.60,
        market_stop_stage2_scale_override=0.30,
        market_stop_state_recovery_override=0.04,
        use_soft_cashflow_weighting=True,
        cashflow_soft_floor_override=0.55,
        cashflow_soft_min_scale_override=0.70,
    ...
    ExperimentSpec(
        name="smart_breadth_quality_3x_ml_champion_sm_sweep_tighter_scales",
        use_reentry_cooldown=False,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        use_dynamic_cluster_caps=True,
        ...
        market_stop_stage1_drawdown_override=0.10,
        market_stop_stage2_drawdown_override=0.14,
        market_stop_stage1_scale_override=0.40,
        market_stop_stage2_scale_override=0.15,
        market_stop_state_recovery_override=0.03,
        use_soft_cashflow_weighting=True,
        cashflow_soft_floor_override=0.55,
        cashflow_soft_min_scale_override=0.70,
    ),
