...
EXPERIMENTS: tuple[ExperimentSpec, ...] = (
    ...
    ExperimentSpec(
        ...
        use_reentry_cooldown=True,
        use_dynamic_gross_target=True,
        stressed_gross_scale_override=0.95,
    ),
    # Edge-floor calibration.
    ExperimentSpec(
        name="cal_ef_010_020",
        use_reentry_cooldown=True,
    ...
    ExperimentSpec(
        ...
        use_vol_norm_trail=True,
        use_hard_stop_loss=True,
        hard_stop_loss_pct_override=0.20,
    ),
    ExperimentSpec(
        name="cal_tail_hs25",
        use_reentry_cooldown=True,
        use_vol_norm_trail=True,
        use_hard_stop_loss=True,
        hard_stop_loss_pct_override=0.25,
    ),
    # Key combinations.
    ExperimentSpec(
        name="combo_rg085_ef012",
        use_reentry_cooldown=True,
        use_dynamic_gross_target=True,
        stressed_gross_scale_override=0.85,
        use_dynamic_edge_floor=True,
...
def main() -> None:
    out_root = Path("trading_research/examples/_output/42_rel2_control_calibration_grid")
    ...
    base = overall_df[overall_df["strategy"] == "baseline_nhf5"]
