...
EXPERIMENTS: tuple[ExperimentSpec, ...] = (
    # Reference on expanded universe.
    ExperimentSpec(name="baseline_expanded_nhf5", use_reentry_cooldown=True),
    # Smart breadth with liquidity, efficacy, mild regime throttle, and dynamic cluster caps.
    ExperimentSpec(
        name="smart_breadth_quality",
    ...
    # Ablation: no efficacy filter.
    ExperimentSpec(
        name="smart_breadth_no_efficacy",
        use_reentry_cooldown=True,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=False,
        use_dynamic_gross_target=True,
        stressed_gross_scale_override=0.95,
        calm_gross_scale_override=1.05,
        use_dynamic_cluster_caps=True,
    ...
    # Ablation: tighter efficacy filter.
    ExperimentSpec(
        name="smart_breadth_quality_top35",
        use_reentry_cooldown=True,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        asset_efficacy_quantile_override=0.65,
        use_dynamic_gross_target=True,
        stressed_gross_scale_override=0.95,
        calm_gross_scale_override=1.05,
        use_dynamic_cluster_caps=True,
...
def main() -> None:
    out_root = Path("trading_research/examples/_output/43_rel2_smart_breadth")
