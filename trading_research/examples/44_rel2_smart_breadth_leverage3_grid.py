...
EXPERIMENTS: tuple[ExperimentSpec, ...] = (
    # 1x reference retained for comparison.
    ExperimentSpec(
        name="baseline_expanded_nhf5",
        use_reentry_cooldown=True,
        gross_target_override=1.0,
        max_abs_weight_per_asset_override=0.04,
        use_dynamic_cluster_caps=False,
    ),
    # Pure 3x baseline (same signal stack, no smart filters).
    ExperimentSpec(
        name="baseline_expanded_nhf5_3x",
        use_reentry_cooldown=True,
        gross_target_override=3.0,
        max_abs_weight_per_asset_override=0.12,
        use_dynamic_cluster_caps=False,
    ),
    # 3x smart breadth core.
    ExperimentSpec(
    ...
    # 3x with slightly looser efficacy to recover breadth.
    ExperimentSpec(
        name="smart_breadth_quality_3x_looser_efficacy",
        use_reentry_cooldown=True,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        asset_efficacy_quantile_override=0.50,
        use_dynamic_cluster_caps=True,
        use_dynamic_edge_floor=True,
        use_custom_edge_threshold=True,
        custom_base_edge_threshold=0.010,
    ...
    # 3x with mild regime throttle around leverage target.
    ExperimentSpec(
        name="smart_breadth_quality_3x_regime_scaled",
        use_reentry_cooldown=True,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        use_dynamic_gross_target=True,
        stressed_gross_scale_override=0.85,
        calm_gross_scale_override=1.10,
        use_dynamic_cluster_caps=True,
        use_dynamic_edge_floor=True,
        use_custom_edge_threshold=True,
        custom_base_edge_threshold=0.010,
    ...
    # 3x lighter risk cap A: milder stress throttle + softer stop.
    ExperimentSpec(
        name="smart_breadth_quality_3x_light_risk_cap_a",
        use_reentry_cooldown=True,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        use_dynamic_gross_target=True,
        stressed_gross_scale_override=0.85,
        calm_gross_scale_override=1.05,
        use_dynamic_cluster_caps=True,
        use_dynamic_edge_floor=True,
        use_custom_edge_threshold=True,
        custom_base_edge_threshold=0.010,
        ...
        use_vol_norm_trail=True,
        use_hard_stop_loss=True,
        hard_stop_loss_pct_override=0.15,
        use_turnover_smoothing=True,
        top_quantile_override=0.93,
        gross_target_override=3.0,
        max_abs_weight_per_asset_override=0.12,
    ),
    # 3x lighter risk cap B: very mild throttle and loose stop.
    ExperimentSpec(
        name="smart_breadth_quality_3x_light_risk_cap_b",
        use_reentry_cooldown=True,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        use_dynamic_gross_target=True,
        stressed_gross_scale_override=0.90,
        calm_gross_scale_override=1.08,
        use_dynamic_cluster_caps=True,
        use_dynamic_edge_floor=True,
        use_custom_edge_threshold=True,
        custom_base_edge_threshold=0.010,
        ...
        use_vol_norm_trail=True,
        use_hard_stop_loss=True,
        hard_stop_loss_pct_override=0.18,
        use_turnover_smoothing=True,
        top_quantile_override=0.93,
        gross_target_override=3.0,
        max_abs_weight_per_asset_override=0.12,
    ),
    # 3x Sharpe-recovery A: tighter quality + modest gross de-risk.
    ExperimentSpec(
        name="smart_breadth_quality_3x_sharpe_recover_a",
        use_reentry_cooldown=True,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        asset_efficacy_quantile_override=0.60,
        use_dynamic_gross_target=True,
        stressed_gross_scale_override=0.82,
        calm_gross_scale_override=1.00,
        use_dynamic_cluster_caps=True,
        use_dynamic_edge_floor=True,
        use_custom_edge_threshold=True,
        ...
        use_turnover_smoothing=True,
        top_quantile_override=0.94,
        gross_target_override=2.8,
        max_abs_weight_per_asset_override=0.10,
    ),
    # 3x Sharpe-recovery B: tighter gates with softer stop.
    ExperimentSpec(
        name="smart_breadth_quality_3x_sharpe_recover_b",
        use_reentry_cooldown=True,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        asset_efficacy_quantile_override=0.62,
        use_dynamic_gross_target=True,
        stressed_gross_scale_override=0.78,
        calm_gross_scale_override=0.98,
        use_dynamic_cluster_caps=True,
        use_dynamic_edge_floor=True,
        use_custom_edge_threshold=True,
        custom_base_edge_threshold=0.013,
        custom_additional_edge_threshold=0.013,
        use_quality_priority_cap=True,
        use_turnover_smoothing=True,
        use_vol_norm_trail=True,
        use_hard_stop_loss=True,
        hard_stop_loss_pct_override=0.16,
        top_quantile_override=0.95,
        gross_target_override=2.6,
        max_abs_weight_per_asset_override=0.09,
    ),
    # 3x Sharpe-recovery C: high-quality long-only defensive blend.
    ExperimentSpec(
        name="smart_breadth_quality_3x_sharpe_recover_c_long_only",
        use_reentry_cooldown=True,
        use_liquidity_filter=True,
        use_asset_efficacy_filter=True,
        asset_efficacy_quantile_override=0.62,
        use_dynamic_gross_target=True,
        stressed_gross_scale_override=0.80,
        calm_gross_scale_override=1.00,
        use_dynamic_cluster_caps=True,
        use_dynamic_edge_floor=True,
        use_custom_edge_threshold=True,
...
def main() -> None:
    out_root = Path("trading_research/examples/_output/44_rel2_smart_breadth_leverage3_grid")
    ...
    base = overall_df[overall_df["strategy"] == "baseline_expanded_nhf5"]
