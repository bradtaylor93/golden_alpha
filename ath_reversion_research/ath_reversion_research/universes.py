...
BROAD_STOCK_UNIVERSE = Universe(
    name="broad_stock_sample",
    symbols=(
        # Mega and large-cap technology / communications.
        "AAPL",
        "MSFT",
        "NVDA",
        "AMZN",
        ...
        "BROS",
        "CHWY",
        # Industrials, energy, materials, and real assets.
        "CAT",
        "DE",
        "GE",
        "HON",
        ...
        "NEM",
        "LIN",
        # Smaller/high-beta operating companies.
        "DUOL",
        "GTLB",
        "AI",
        "UPST",
    ...
    description=(
        "Broad stock-only sample across sectors and market caps for testing "
        "single-name technical strategies on many names."
    ),
)
...
DEFAULT_UNIVERSES = {
    ...
    BROAD_STOCK_UNIVERSE.name: BROAD_STOCK_UNIVERSE,
}
